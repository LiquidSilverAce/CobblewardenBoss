...
public class BossSpawner {
    ...
    private static String getSpawnCommand(String species, BlockPos pos) {
        ...
        switch (species) {
            ...
            case "exploud":
                command = String.format(
                    "pokespawnat %d %d %d exploud level=100 nature=rash special_attack_ev=252 attack_ev=252 special_attack_iv=31 attack_iv=31 uncatchable=true",
                    spawnX, spawnY, spawnZ
                );
                break;
            case "guzzlord":
                command = String.format(
                    "pokespawnat %d %d %d guzzlord level=100 nature=adamant attack_ev=252 hp_ev=252 attack_iv=31 hp_iv=31 uncatchable=true",
                    spawnX, spawnY, spawnZ
                );
                break;
            default:
                command = String.format(
                    "pokespawnat %d %d %d %s level=100 uncatchable=true",
                    spawnX, spawnY, spawnZ, species
                );
                break;
        }
